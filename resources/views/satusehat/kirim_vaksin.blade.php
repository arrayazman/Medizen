...
@section('page-title', 'Kirim Vaksin (Auto-Fix)')
...
<div class="card card-medizen rounded-0 border-0 shadow-none">
    <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom rounded-0">
        <div>
            <h5 class="mb-0 fw-bold text-slate-800" style="font-size: 1.1rem;">Kirim Vaksin (Auto-Fix)</h5>
            <div class="text-muted small" style="font-size: 0.65rem;">AUTOMATIC DATA CORRECTION & DEFAULTS</div>
        </div>
