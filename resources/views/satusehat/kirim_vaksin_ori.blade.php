...
@section('page-title', 'Kirim Vaksin (Strict) SATUSEHAT')
...
<div class="card card-medizen rounded-0 border-0 shadow-none">
    <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom rounded-0 py-2">
        <div>
            <h5 class="mb-0 fw-bold text-slate-800" style="font-size: 1.1rem;">Kirim Vaksinasi (Strict Mode)</h5>
            <div class="text-muted small" style="font-size: 0.65rem;">BRIDGING VAKSINASI DENGAN VALIDASI KETAT DATA MASTER & FHIR RESOURCE</div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-0">
            <div class="modal-header py-2 px-3 bg-dark">
                <h6 class="modal-title px-0 text-white">SYSTEM LOG: IMMUNIZATION (STRICT)</h6>
